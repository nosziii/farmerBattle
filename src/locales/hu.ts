const messages = {
  ...
  expeditions: {
    ...
    reports: 'Jelentések',
    reportsPageTitle: 'Expedíciós jelentések',
    reportsPageSubtitle: 'Tekintsd át a korábbi expedíciók eredményeit.',
    loadingReports: 'Jelentések betöltése...',
    noCompletedExpeditions: 'A befejezett expedíciók itt fognak megjelenni zsákmányukkal és csatajelentésükkel.',
    outcome: 'Eredmény',
    loot: 'Zsákmány',
    troops: 'Egységek',
    battleReport: 'Csatajelentés',
    noReportAvailable: 'Nincs elérhető jelentés.',
    sent: 'Elküldve',
    returned: 'Visszatért',
    lost: 'Elveszett',
    ...
    failed: 'Sikertelen',
    completed: 'Befejezve',
    completedAt: 'Befejezve: {time}',
    distance: 'Távolság: {distance} mező',
    signInToViewReports: 'Jelentkezz be az expedíciós jelentések megtekintéséhez.',
    createVillageToViewReports: 'Hozzon létre egy falut az expedíciós jelentések megtekintéséhez.',
    unableToLoadReports: 'Jelenleg nem sikerült betölteni az expedíciós jelentéseket.',
    nearbyBarbarianVillages: 'Közeli barbár falvak',
    found: '{count} található',
    noBarbarianVillagesFound: 'Még nem fedeztek fel barbár falvakat a térképen.',
    planExpedition: 'Expedíció tervezése',
    levelShort: '{level}. szint',
    warriors: 'Harcosok: {warriors}',
    distanceTiles: 'Távolság: {distance} mező',
    launchExpedition: 'Expedíció indítása',
    sendTroopsDescription: 'Küldj csapatokat a közeli barbár falvak kifosztására erőforrásokért.',
    activeExpeditions: 'Aktív expedíciók',
    active: '{count} aktív',
    loadingExpeditions: 'Expedíciók betöltése...',
    noActiveExpeditions: 'Jelenleg nincsenek úton csapatok. Indítson új expedíciót a barbárok kifosztásához.',
    prepareExpedition: 'Expedíció előkészítése',
    prepareExpeditionDescription: 'Válasszon barbár célpontot és ossza be a csapatokat. Az utazási idő a távolságtól és a leglassabb egységtől függ.',
    close: 'Bezárás',
    loadingPlannerData: 'Tervező adatok betöltése...',
    targetVillage: 'Célfalu',
    selectATarget: 'Válasszon célpontot',
    estimatedTravel: 'Becsült utazási idő',
    eachWay: 'oda-vissza',
    estimatedArrival: 'Becsült érkezés',
    estimatedReturn: 'Becsült visszatérés',
    troopAllocation: 'Csapatbeosztás',
    noTroopsAvailable: 'Nincsenek elérhető csapatok. Először képezzen egységeket a kaszárnyában.',
    cost: 'Költség {wood}/{clay}/{iron}',
    speed: 'Sebesség {speed}',
    carry: 'Szállítókapacitás {carry}',
    available: 'Elérhető {available}',
    requires: 'Szükséges',
    max: 'Max',
    selectTargetBarbarianVillage: 'Válasszon cél barbár falut.',
    selectAtLeastOneUnit: 'Válasszon legalább egy egységet ehhez az expedícióhoz.',
    unableToLaunchExpedition: 'Nem sikerült elindítani az expedíciót.',
    totalUnitsSelected: 'Összes kiválasztott egység:',
    reset: 'Visszaállítás',
    launching: 'Indítás...',
    launchExpeditionButton: 'Expedíció indítása',
    signInToManageExpeditions: 'Jelentkezzen be az expedíciók kezeléséhez.',
    createVillageToLaunchExpeditions: 'Hozzon létre egy falut az expedíciók indításához.',
    expeditionLaunched: 'Expedíció indítva ide: {targetName}!',
    total: 'összesen',
  },
  sidebar: {
    brand: {
